...
novice from a professional: a novice, who is not used to exertion for an
...
So let's try that with our signal:
...
Before you hook up a subject you have a couple of decisions to make: What
...
![](./img/groupexercise_web.jpg)](https://backyardbrains.com/experiments/img/groupexercise_web.jpg)
  ...
  1. First, connect your subject to the Muscle SpikerBox and your Muscle Spikerbox to 1) your computer using a USB or laptop cable or 2) to smartphone/tablet using the green smartphone cable. Begin by testing your signal: have your subject flex a few times and watch your display to see the spikes. 
  2. Next, we want to adjust the gain. Turn the wheel on your Muscle SpikerBox all the way up, then have your subject flex as hard as they can. If the signal is clipping, like this: 
...
![](./img/Clipped_Signal.jpg)](https://backyardbrains.com/experiments/img/Clipped_Signal.jpg)
  ...
  5. When the subject can no longer maintain the weight, stop the recording. Your recording may look something like this: 
...
_Quick Note:_ Do not change the gain while you are doing a recording, as this
...
something quantifiable.
  ...
  1. Open up your first recording, zoom all the way out; we're going to be measuring the RMS from the first and last five seconds of the recording: 
...
**First, note: Depending on which muscle you choose to record from, the
...
([example](http://www.ncbi.nlm.nih.gov/pubmed/10643144)), and it has been
...
running](http://faculty.washington.edu/crowther/Misc/RBC/gender.shtml) and it
