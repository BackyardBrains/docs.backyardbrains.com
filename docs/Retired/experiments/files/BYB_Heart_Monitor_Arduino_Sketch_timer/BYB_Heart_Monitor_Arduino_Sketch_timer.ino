...
int interrupt_Number=15999; // = (16*10^6) / (1000*8) - 1 // IMPORTANT!!!!! set to 1999 for 1000 Hz sampling, set to 3999 for 500 Hz sampling, set to 7999 for 250Hz sampling, 15999 for 125 Hz Sampling
