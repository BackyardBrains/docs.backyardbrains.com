...
##### Prerequisite Labs
  ...
  * [Experiment_ Control Machines with Your Brain](https_//backyardbrains.com/experiments/muscleSpikerShield) \- This will introduce you to the concept of digitizing body signals for control applications.
  * [Experiment_ Eye Potentials (EOG)](https_//backyardbrains.com/experiments/EOG) \- This will introduce to the voltage changes you can measure when the eye blinks and moves.

##### Equipment

[Muscle SpikerBox Pro](https_//backyardbrains.com/products/MuscleSpikerBoxPro)

[Game Controller](https_//backyardbrains.com/products/GameController)
...
control
[claws](https_//backyardbrains.com/experiments/MuscleSpikerShield_GripperHand),
[prosthetic hands](https_//backyardbrains.com/experiments/diyneuroprosthetic),
and even [other
humans](https_//backyardbrains.com/experiments/humanhumaninterface). But,
...
[
![](./img/MarioLuigi_web.jpg)](https_//backyardbrains.com/experiments/img/MarioLuigi_web.jpg)
...
[
![](./img/Interface_symbols_web.jpg)](https_//backyardbrains.com/experiments/img/Interface_symbols_web.jpg)
...
shown](https_//backyardbrains.com/experiments/muscleSpikerShield) in our
...
things](http_//www.pnas.org/content/101/51/17849), but is more difficult and
...
pitch](https_//www.youtube.com/watch?v=uarpHx8JsEQ&feature=youtu.be) and an
[electronic music circuit](http_//blog.backyardbrains.com/2017/03/brainding-
...
[exercise](https_//backyardbrains.com/experiments/heartrate) (increase your
heart rate), holding your breath/exposing your face to [cold
water](https_//backyardbrains.com/experiments/Sympathetic_Nervous_System)
(lowering your heart), or breathing rapidly to [decrease your carbon
dioxide](https_//en.wikipedia.org/wiki/Hyperventilation) blood level (increase
...
> using an emulator like [JNES](http_//www.jabosoft.com/categories/1) and a
...
> Mario](https_//www.gameshaha.net/super-mario-bros/) (which features re-
> programmable inputs!)
>
...
[
![](./img/GameControllerSetup.jpg)](https_//backyardbrains.com/experiments/img/GameControllerSetup.jpg)
...
[
![](./img/GameControllerOptions2.png)](https_//backyardbrains.com/experiments/img/GameControllerOptions2.png)
...
[
![](./img/GameControllerOptions4.png)](https_//backyardbrains.com/experiments/img/GameControllerOptions4.png)
...
[
![](./img/GameControllerOptions5.png)](https_//backyardbrains.com/experiments/img/GameControllerOptions5.png)

  8. For your eye-blink, set a threshold that triggers with the peak of your eye blink signals. 

[
![](./img/GameControllerOptions3.png)](https_//backyardbrains.com/experiments/img/GameControllerOptions3.png)
...
[
![](./img/GameControllerOptions6.png)](https_//backyardbrains.com/experiments/img/GameControllerOptions6.png)
