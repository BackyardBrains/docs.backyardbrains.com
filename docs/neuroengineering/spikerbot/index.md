...
**Built for classrooms and livingrooms.** SpikerBot translates complex brain science into an affordable, hands-on robot that lets students model neural circuits with a drag-and-drop interface, see neural activity drive robot behavior, and build skills that underpin modern neurotechnology, nervous system medicine, and neuromorphic AI. 

![App Design Mode Screenshot](./img/educatorguide2.jpg)
