   ...
   if(outputBufferReady == 1)//if we have new data
   {
     ...
     else
     {
      //-------------------------------- MAIN LOOP shift out one bit of data --------------------------------------------------- 
        ...
        //Maping for Leonardo
         /* D2         PD1                   - data for SHIFT registers
          * D3         PD0                   - clock for SHIFT registers
          * D4         PD4                   - latch for shift registers
          * */
       ...
       if(countdownTimerForLeds>0)
        {
          ...
          if(countdownTimerForLeds <START_OF_LED_DIMMING)
          {
              ...
              /*
              *  Maping for Leonardo 
              *  PIN13      PC7        - enable pin for color coded LEDs
              */
          ...
          else
          {
            ...
            PORTC |= B10000000; //turn ON LED enable pin 13  
          }
        ...
        else
        {
           ...
           PORTC &= B01111111; //turn OFF LED enable pin 13  
        }
        ...
        /*
         * Mapping for Leonardo pins
         *  D7, PE6 - outputs to ESP module
         *  D8, PB4 - outputs to ESP module
         *  D9, PB5- outputs to ESP module
         *  D10, PB6- outputs to ESP module
         *  D11, PB7- outputs to ESP module
         *  D12   PD6- outputs to ESP module  
         */
