...
Uno](http://arduino.cc/en/Main/arduinoBoardUno) board. What is this 'Arduino,'
you may ask? An Arduino is a
[microcontroller](http://en.wikipedia.org/wiki/Single-board_microcontroller).
Microcontrollers are simple devices at heart: they take input signals, execute
...
> ](http://arduino.cc/en/guide/macOSX#.UyIU2IW3t4w). Note: If you bought our
> [Muscle SpikerShield
...
[ ![](./img/AeonFlux_expimg.jpg) Advanced Neuro-Prosthetics: Take Someone's
