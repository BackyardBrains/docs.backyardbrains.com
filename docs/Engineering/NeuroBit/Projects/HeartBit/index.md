...
![SIG](./6.png)
3. We've also used a simple casing with a switch for our example, we recommend you also make some sort of housing device to hold the neuro:bit in place
![PlaceHolder](./7.png)
![HoldingNB](./8.png)
...
![Sig2](./11.png)
![Gnd2](./12.png)
9. At this point, you can connect yourself to the neuro:bit.
![MostlySet](./15.png)
10. If you have a strap, you can also attach the neuro:bit box to your wrist, thus allowing for (mostly) hands-free control
![Holder1](./16.png)
![Holder2](./17.png)
...
![Finished](./19.png)
We have the micro:bit and neuro:bit devices connected and
