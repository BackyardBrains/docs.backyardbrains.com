...
slug: /
sidebar_position: 1
title: Backyard Brains Documentation
description: Explore neuroscience through hands-on experiments with Backyard Brains devices, software, and educational resources.
---
...
1. [Choose your device](#choose-your-device).
2. Install [Spike Recorder](./software/spike-recorder/) on your computer, phone, or tablet.
3. Follow the setup instructions on your device's documentation page.
4. Run an experiment and observe real biological signals.
5. If something is not working, visit the [Spike Recorder Troubleshooting Guide](./software/spike-recorder/troubleshooting/).
...
- [SpikeStation](./invertebrate/spikestation/) *(pre-release)*
...
- [Spiker:bit](./neuroengineering/spikerbit/)
- [SpikerBot](./neuroengineering/spikerbot/)
...
- [Spike Recorder overview](./software/spike-recorder/)
- [Connection methods](./software/spike-recorder/connection-methods/)
- [Windows, macOS, and Linux](./software/spike-recorder/desktop/)
- [iOS and iPadOS](./software/spike-recorder/ios-ipados/)
- [Android](./software/spike-recorder/android/)
- [Web version](./software/spike-recorder/web/) *(in development)*
...
- Visit the [Spike Recorder Troubleshooting Guide](./software/spike-recorder/troubleshooting/).
...
- [Media Usage](./policies/content-policy/)
- [Backyard Brains Style Guide](./policies/style-guide/)
